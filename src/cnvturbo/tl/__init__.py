...
def pca(
    ...
    **kwargs,
    ...
    """Compute the PCA on the result of :func:`cnvturbo.tl.infercnv`.
...
def umap(
    ...
    **kwargs,
    ...
    """Compute the UMAP on the result of :func:`cnvturbo.tl.infercnv`.
    ...
    adata
        annotated data matrix
    neighbors_key
        Key under which the result of :func:`cnvturbo.pp.neighbors` is stored
        in adata
    key_added
...
def tsne(
    ...
    **kwargs,
    ...
    """Compute the t-SNE on the result of :func:`cnvturbo.tl.infercnv`.
    ...
    adata
        annotated data matrix
    use_rep
        Key under which the result of :func:`cnvturbo.tl.pca` is stored
        in adata
    key_added
