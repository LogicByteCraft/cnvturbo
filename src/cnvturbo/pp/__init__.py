...
def neighbors(
    ...
    **kwargs,
    ...
    """Compute the neighborhood graph based on the result from :func:`cnvturbo.tl.infercnv`.
    ...
    adata
        AnnData object
    use_rep
        Key under which the PCA of the results of :func:`cnvturbo.tl.infercnv`
        are stored in anndata. If not present, attempts to run :func:`cnvturbo.tl.pca`
